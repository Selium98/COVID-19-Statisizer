		...
		<div class="row">
			<div class="col-lg-8 offset-lg-2 col-12">
				...
				<div class="custom-control custom-checkbox custom-control-inline text-capitalize">
					...
					<div class="custom-control custom-checkbox custom-control-inline text-capitalize">
				    	<input type="checkbox" class="custom-control-input" id="customcheckbox6" name="coronasym[]" value="sorethr">
				    	<label class="custom-control-label" for="customcheckbox6">Sore Throat</label>
				    </div>
